import{M as c,c as n,a as o,i,t as a}from"./index-4bd6c1a1.js";const h=a('<p><img width="100%" src="./logo.svg" alt="Solid Docs"><br></p>',4);function s(l){const e=Object.assign({div:"div",p:"p",h2:"h2",ul:"ul",li:"li",a:"a",strong:"strong",pre:"pre",code:"code",span:"span"},c(),l.components),{ContextualNav:t}=e;return t||d("ContextualNav",!0),n(e.div,{className:"markdown-body",get children(){return[(()=>{const r=h.cloneNode(!0);return r.firstChild.nextSibling,i(r,n(e.p,{children:"Collection of Solid utilities inspired completely by VueUse"}),null),r})(),`
...
`,n(t,{links:[{href:"#features",label:"🚀 Features",indent:!1},{href:"#usage",label:"🦄 Usage",indent:!1},{href:"#install",label:"📦 Install",indent:!1},{href:"#demos",label:"Demos",indent:!1},{href:"#contribute",label:"🧱 Contribute",indent:!1},{href:"#thanks",label:"🌸 Thanks",indent:!1},{href:"#license",label:"📄 License",indent:!1}]})]}})}function y(l={}){const{wrapper:e}=Object.assign({},c(),l.components);return e?n(e,o(l,{get children(){return n(s,l)}})):s(l)}function d(l,e){throw new Error("Expected "+(e?"component":"object")+" `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}export{y as default};
