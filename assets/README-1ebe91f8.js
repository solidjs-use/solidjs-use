import{M as o,c as n,a as c,i,t as a}from"./index-4dfc23d9.js";const d=a('<p><img width="100%" src="./logo.svg" alt="Solid Docs"><br></p>',4);function s(l){const e=Object.assign({div:"div",p:"p",h2:"h2",ul:"ul",li:"li",a:"a",strong:"strong",pre:"pre",code:"code",span:"span"},o(),l.components),{ContextualNav:t}=e;return t||h("ContextualNav",!0),n(e.div,{className:"markdown-body",get children(){return[(()=>{const r=d.cloneNode(!0);return r.firstChild.nextSibling,i(r,n(e.p,{children:"Collection of Solid utilities inspired completely by VueUse"}),null),r})(),`
...
`,n(e.h2,{children:"playground"}),`
`,n(e.p,{get children(){return n(e.a,{href:"/solidjs-use-playground/",children:"playground"})}}),`
`,n(e.h2,{children:"Demos"}),`
`,n(e.ul,{get children(){return[`
...
`,n(t,{links:[{href:"#features",label:"🚀 Features",indent:!1},{href:"#usage",label:"🦄 Usage",indent:!1},{href:"#install",label:"📦 Install",indent:!1},{href:"#playground",label:"playground",indent:!1},{href:"#demos",label:"Demos",indent:!1},{href:"#contribute",label:"🧱 Contribute",indent:!1},{href:"#thanks",label:"🌸 Thanks",indent:!1},{href:"#license",label:"📄 License",indent:!1}]})]}})}function g(l={}){const{wrapper:e}=Object.assign({},o(),l.components);return e?n(e,c(l,{get children(){return n(s,l)}})):s(l)}function h(l,e){throw new Error("Expected "+(e?"component":"object")+" `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}export{g as default};
