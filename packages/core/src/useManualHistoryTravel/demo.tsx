...
import { formatDate, useCounter, useManualHistoryTravel } from 'solidjs-use'
...
const Demo = () => {
  ...
  const { canUndo, canRedo, history, commit, undo, redo } = useManualHistoryTravel([count, set as Setter<number>], {
    capacity: 10
  })
