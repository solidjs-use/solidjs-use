...
import { formatDate, useCounter, useDebouncedHistoryTravel } from 'solidjs-use'
...
const Demo = () => {
  ...
  const { history, undo, redo, canUndo, canRedo } = useDebouncedHistoryTravel([count, set as Setter<number>], {
    capacity: 10,
    debounce: delay
  })
