  ...
  return (
    <>
      <div class="font-mono">
        <div>
          {' '}
          sm(&lt;{smWidth}px): <BooleanDisplay value={sm()} />
        </div>
        <div>
          {' '}
          sm(&lt;={smWidth}px): <BooleanDisplay value={sme()} />
        </div>
        <div>
          {' '}
          md: <BooleanDisplay value={md()} />
        </div>
        <div>
          {' '}
          lg: <BooleanDisplay value={lg()} />
        </div>
        <div>
          {' '}
          xl: <BooleanDisplay value={xl()} />
        </div>
        <div>
          2xl: <BooleanDisplay value={xxl()} />
        </div>
        <div>
          3xl: <BooleanDisplay value={xxxl()} />
        </div>
      </div>
    </>
  )
