...
- If you'd like to introduce 3rd-party dependencies, please contribute to @solidjs-use/integrations or create a new add-on.
...
index.test.ts       # cypress unit testing
...
Read more about the [guidelines](https://solidjs-use.github.io/solidjs-use/guidelines).
